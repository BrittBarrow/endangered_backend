...
animals = Animal.create([{species: 'Jaguar'},
   ...
   habitat_animals = HabitatAnimals.create([{endangered_habitat_id: 1,animal_id: 1},{endangered_habitat_id: 1,animal_id: 2},{endangered_habitat_id: 1,animal_id: 3},{endangered_habitat_id: 1, animal_id: 4},{endangered_habitat_id: 1, animal_id: 5},{endangered_habitat_id: 2,animal_id: 1},{endangered_habitat_id: 2,animal_id: 6},
